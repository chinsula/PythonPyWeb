...
class Author(models.Model):
    ...
    username = models.SlugField(verbose_name='Имя аккаунта',
                                help_text="Введите username, не длиннее 50 символов. "
                                          "Использовать нужно английский алфавит, разделять "
                                          "фразы нужно символом '-'",
                                unique=True)
    ...
    self_esteem = models.DecimalField(max_digits=2,
                                      ...
                                      help_text="Введите уровень вашей самооценки, только честно! "
                                                "Градация от 0 до 5, где 0 - 'я молодец', "
                                                "5 - 'я умница'",
                                      null=True,
                                      blank=True,
                                      )
    ...
    phone_number = models.CharField(max_length=12,
                                    ...
                                    help_text="Введите номер телефона через '+7' "
                                              "без пробелов в формате +79123456789 ",
                                    null=True,
                                    blank=True,
                                    unique=True
                                    )
    ...
    status_rule = models.BooleanField(verbose_name='Согласие с правилами',
                                      help_text="А ты их читал или как обычно "
                                                "просто галочку поставил?",
                                      )

    image = models.ImageField(upload_to='foto_profile',
                              verbose_name='Картинка профиля',
                              help_text="Фото в профиль, можно не своё! "
                                        "Ну или хоть какое-то. Ладно можно без фото",
                              null=True,
                              blank=True,
                              )
